...
"""
    ...
    """
def egalitarian_allocation(matrix_of_preferences):
    """
    ...
    >>> result1 = egalitarian_allocation([[80,19,1], [79,1,20]])
    >>> result1[0]
    'optimal'
    >>> round(result1[1], 2)
    59.25
    ...
    >>> result2 = egalitarian_allocation([[100,0], [0,50]])
    >>> result2[0]
    'optimal'
    >>> round(result2[1], 2)
    50.0
    ...
    >>> result3 = egalitarian_allocation([[0,0], [0,0]])
    >>> result3[0]
    'optimal'
    >>> round(result3[1], 2)
    0.0
    ...
    >>> result4 = egalitarian_allocation([[100,20], [20,100]])
    >>> result4[0]
    'optimal'
    >>> round(result4[1], 2)
    100.0
    ...
    >>> result5 = egalitarian_allocation([[0,0,3], [0,21,0], [11,0,0]])
    >>> result5[0]
    'optimal'
    >>> round(result5[1], 2)
    3.0
    ...
    >>> result6 = egalitarian_allocation([[2,4,8], [8,2,4], [2,3,2]])
    >>> result6[0]
    'optimal'

    #test7 - 4 players with 2 resources:
    >>> result7 = egalitarian_allocation([[100,0],[0,100],[50,50],[30,30]])
    >>> result7[0]
    'optimal'

    #test8 - 3 players with 4 resources:
    >>> result8 = egalitarian_allocation([[100,0,3,4],[0,100,1,2],[50,50,4,5],[30,30,7,7]])
    >>> result8[0]
    'optimal'

    #test9 - 2 players with values between 0 and 1:
    >>> result9 = egalitarian_allocation([[0.7, 0.1],[0.3, 0.4]])
    >>> result9[0]
    'optimal'

    #test10 - I would like to check that if there is a negative value in the matrix its not working:
    >>> egalitarian_allocation([[-10, 20], [30, 40]])
